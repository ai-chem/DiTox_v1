...
path_to_data = os.path.join(os.getcwd(), "final_model/dataset_3090.csv")
...
params = {
    "n_estimators": 1000,
    "learning_rate": 0.15938838601470637,
    "num_leaves": 23,
    "max_depth": 12,
    "min_data_in_leaf": 3,
    "lambda_l1": 5,
    "lambda_l2": 1,
    "min_gain_to_split": 4.679137455449418,
...
for train_index, test_index in kf.split(X):
    ...
    new_regressor = LGBMRegressor(**params)
...
plt.title("Visualization of LGBMRegressor prediction on test data")
plt.show()
