...
dataset.drop(["Unnamed: 0", "Material", "Test_indicator", "Elements"], axis=1, inplace=True)
...
regressor.fit(train_pool, metric_period=100)
...
for train_index, test_index in kf.split(X):
    ...
    new_regressor.fit(train_pool, metric_period=100)
