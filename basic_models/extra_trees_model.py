...
# path_to_data = "https://raw.githubusercontent.com/djzhendogg/predicting-toxicity-of-nanomaterials/master/final_df_wthz_4080.csv"
...
for train_index, test_index in kf.split(X):
    ...
    new_regressor = ExtraTreesRegressor()
...
plt.title("Visualization of ExtraTreesRegressor prediction on test data")
plt.show()
